#!/usr/bin/python3
"""Write a Function that test Square class"""
...
class TestSquare_instantation(unittest.TestCase):
    """unit Test for instantation of the square"""
    ...
    def test_four_argument(self):
        s1 = Square(1, 2, 3, 4)
        self.assertEqual(4, s1.id)

    def test_more_than_four_argument(self):
        with self.assertRaises(TypeError):
            Square(1, 2, 3, 4, 5)
...
class TestSquare_size(unittest.TestCase):
    """unittest for testing size initialization of theSquare"""
...
class TestSquare_order_of_given_value(unittest.TestCase):
    """Unittest for testing more than one invalid object"""

    def test_size_befor_all(self):
        with self.assertRaisesRegex(TypeError, "width must be an integer"):
            Square("INvalid by Girma", "in valid by Tarekegn")

    def test_size_befor_y(self):
        with self.assertRaisesRegex(TypeError, "width must be an integer"):
            Square("INvalid by Girma", 1, "invalid by Tarekegn")
...
class TestSquare_area(unittest.TestCase):
    """Unittest for testing the area method of the Square"""
...
class TestSquare_stdout(unittest.TestCase):
    """unittest for testing __str__ and display mothod"""

    @staticmethod
    def capture_stdout(square, method):
        """captures and return text printed"""
